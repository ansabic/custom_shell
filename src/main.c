...
int lsh_random(char **args);
int printDir(char **args);
...
///Source: https://stackoverflow.com/questions/38426345/how-to-code-my-own-version-of-mv-rename-move-unix-command-in-c-language
...
int lsh_mv(char **args)
{
    if (args[1] == NULL || args[2] == NULL) {
        fprintf(stderr, "mv: missing source and/or destination file\n");
        return 1;
    }
